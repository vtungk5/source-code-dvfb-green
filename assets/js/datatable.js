...
(function (l) {
    ...
    function Kb(a) {
        ...
        b = l("<div/>", { id: h.f ? null : c + "_filter", class: b.sFilter }).append(l('<label class="w-100" />').append(g));
        var k = function (n) {
    ...
    function Jb(a) {
        ...
        var k = l('<div><label class="w-100" /></div>').addClass(b.sLength);
    ...
    u.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: '<div class="text-center mt-4"><img src="/assets/img/icon/404.png" width="85" height="85"><p class="fw-600 mt-2">Không tìm thấy danh sách...</p></div>',
            ...
            sUrl: "",
            sZeroRecords: '<div class="text-center mt-4"><img src="/assets/img/icon/404.png" width="85" height="85"><p class="fw-600 mt-2">Không tìm thấy kết quả...</p></div>',
        },
...
(function (a) {
    ...
    a.extend(!0, d.defaults, { dom: "<'row'<'col-lg-6 mb-2'l><'col-lg-6 mb-2'f>><'row'<'table-responsive'tr>><'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7'p>>", renderer: "bootstrap" });
    a.extend(d.ext.classes, {
        sWrapper: "dataTables_wrapper dt-bootstrap5",
        sFilterInput: "form-control w-100",
        sLengthSelect: "form-control w-100",
