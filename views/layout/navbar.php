<div class="navbar">
    ...
    <div class="info-v">
        <?php if (!Auth::user()) : ?>
            ...
            <a class="btn-v dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" data-mobile="on">
                <img width="35" src="/assets/img/icon/7893923.png">
            </a>
        ...
        <?php else : ?>
            <a class="btn-v dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                <img width="35" src="/assets/img/icon/7893923.png">
            </a>
            <ul class="dropdown-menu users-menu dropdown-info" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="/profile/info">Cài đặt tài khoản</a></li>
